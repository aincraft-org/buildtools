 ...
 * {@code masonry.bypass.creative}/{@code masonry.bypass.survival} skip cost. Refund leftovers drop
 * at the player.
 */
public final class PaperSurvivalTransaction implements SurvivalTransaction {
    ...
    public boolean bypassesCost(ActorId actor) {
        ...
        return player.getGameMode() == GameMode.CREATIVE
                || player.hasPermission("masonry.bypass.creative")
                || player.hasPermission("masonry.bypass.survival");
    }
